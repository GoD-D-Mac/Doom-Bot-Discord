...
exports.run = async(client, message, args) => {
    if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.channel.send(message.author.tag +' **You Don\'t have permissions to use that command**');
...
exports.help = {
    ...
    usage: "/tempmute <@user> <s, m, h, w> <reseaon>",
    example: "/tempmute @dumbo 1h He is dumb"
}
